...
<div class="card mb-5">
    ...
    <div class="card-header flex justify-content-between align-items-center">
        <span class="text-xl">Create New OAuth Application</span>
    </div>
    ...
    <form action="{{ route('app.admin.api.index') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    ...
                    <small id="homepage_url" class="form-text text-muted">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    ...
                    <small id="redirect" class="form-text text-muted">
        ...
        <div class="card-footer flex justify-end">
            <a href="{{ route('app.admin.api.index') }}" class="btn btn-outline-secondary mr-2">Cancel</a>
